      ...
      return function(e2) {
        ...
        var u = function(e3) {
          var t2 = function(e4, t3) {
            var r2 = h(e4), l2 = t3 && t3.length;
            return Array.from({ length: 4 }, function(e5, i2) {
              return { color: f(r2 + i2, t3, l2), translateX: m(r2 * (i2 + 1), 40 - (i2 + 17), 1), translateY: m(r2 * (i2 + 1), 40 - (i2 + 17), 2), rotate: m(r2 * (i2 + 1), 360), isSquare: s(r2, 2) };
            });
          }(e3.name, e3.colors);
          return n.createElement("svg", { viewBox: "0 0 80 80", fill: "none", role: "img", xmlns: "http://www.w3.org/2000/svg", width: e3.size, height: e3.size }, e3.title && n.createElement("title", null, e3.name), n.createElement("mask", { id: "mask__bauhaus", maskUnits: "userSpaceOnUse", x: 0, y: 0, width: 80, height: 80 }, n.createElement("rect", { width: 80, height: 80, rx: e3.square ? void 0 : 160, fill: "#FFFFFF" })), n.createElement("g", { mask: "url(#mask__bauhaus)" }, n.createElement("rect", { width: 80, height: 80, fill: t2[0].color }), n.createElement("rect", { x: 10, y: 30, width: 80, height: t2[1].isSquare ? 80 : 10, fill: t2[1].color, transform: "translate(" + t2[1].translateX + " " + t2[1].translateY + ") rotate(" + t2[1].rotate + " 40 40)" }), n.createElement("circle", { cx: 40, cy: 40, fill: t2[2].color, r: 16, transform: "translate(" + t2[2].translateX + " " + t2[2].translateY + ")" }), n.createElement("line", { x1: 0, y1: 40, x2: 80, y2: 40, strokeWidth: 2, stroke: t2[3].color, transform: "translate(" + t2[3].translateX + " " + t2[3].translateY + ") rotate(" + t2[3].rotate + " 40 40)" })));
        };
        var d = function(e3) {
          var t2 = function(e4, t3) {
            var r2 = h(t3), l2 = e4 && e4.length, i2 = Array.from({ length: 5 }, function(t4, i3) {
              return f(r2 + i3, e4, l2);
            }), a2 = [];
        ...
        var p = function(e3) {
          ...
          var t2 = e3.variant, r2 = void 0 === t2 ? "marble" : t2, n2 = e3.colors, h2 = void 0 === n2 ? ["#92A1C6", "#146A7C", "#F0AB3D", "#C271B4", "#C20D90"] : n2, o2 = e3.name, s2 = void 0 === o2 ? "Clara Barton" : o2, m2 = e3.square, f2 = void 0 !== m2 && m2, v2 = e3.title, b = void 0 !== v2 && v2, _ = e3.size, F = function(e4) {
            ...
            return e4;
          }({ colors: h2, name: s2, title: b, size: void 0 === _ ? 40 : _, square: f2 }, a(e3, ["variant", "colors", "name", "square", "title", "size"]));
          return { pixel: c.a.createElement(g, F), bauhaus: c.a.createElement(u, F), ring: c.a.createElement(d, F), beam: c.a.createElement(w, F), sunset: c.a.createElement(E, F), marble: c.a.createElement(p, F) }[Object.keys(x).includes(r2) ? x[r2] : y.includes(r2) ? r2 : "marble"];
        };
        t.default = v;
      }]);
    });
...
// dep:boring-avatars
var boring_avatars_default = require_build();
export {
  boring_avatars_default as default
};
